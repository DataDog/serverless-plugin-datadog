...
| `enableStepFunctionsTrace`    | Enable automatic subscription of the Datadog Forwarder to Step Function log groups and Step Functions tracing. If no Step Function log groups are configured then they will be automatically created. Requires setting `forwarderArn`. Defaults to `false`.                                                                                                                                                                  |
