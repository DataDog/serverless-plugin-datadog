...
| `subscribeToStepFunctionLogs`    | Enable automatic subscription of the Datadog Forwarder to Step Function log groups. If no Step Function log groups are configured then they will be automatically created. Requires setting `forwarderArn`. Defaults to `false`. |
