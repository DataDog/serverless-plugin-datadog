...
| `apiKeySecretARN`           | The ARN of the secret storing the Datadog API key in AWS Secrets Manager. If set, remember to add the `secretsmanager:GetSecretValue` permission to the Lambda execution role.                                                                                                                                                                                                                                                           |
