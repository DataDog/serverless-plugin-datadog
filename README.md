...
| `subscribeToApiGatewayLogs` | Enable automatic subscription of the Datadog Forward to API Gateway log groups. Defaults to `true`.                                                                                                                                                                                                                                                                                                                 |
| `subscribeToHttpApiLogs` | Enable automatic subscription of the Datadog Forward to Http-api log groups. Defaults to `true`.                                                                                                                                                                                                                                                                                                                 |
| `subscribeToWebsocketLogs` | Enable automatic subscription of the Datadog Forward to Websocket log groups. Defaults to `true`.                                                                                                                                                                                                                                                                                                                 |
