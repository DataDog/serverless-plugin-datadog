...
| `monitorsApiKey`       | Datadog API Key. Only needed when using plugin to create monitors for your function and when `monitors` is defined. Separate from  `apiKey` with your function,  `monitorsApiKey` is only used to create monitors through the Datadog Monitors API.                                                                                                                                                                                                            |
