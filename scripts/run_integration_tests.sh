...
for ((i = 0; i < ${#SERVERLESS_CONFIGS[@]}; i++)); do
    ...
    perl -p -i -e 's/(arn:aws:lambda:sa-east-1:464622532012:layer:Datadog-(Python36|Python37|Python38|Python39|Node12-x|Node14-x|Extension|Dotnet6|Dotnetcore3.1):\d+)/arn:aws:lambda:sa-east-1:464622532012:layer:Datadog-\2:XXX/g' ${RAW_CFN_TEMPLATE}
